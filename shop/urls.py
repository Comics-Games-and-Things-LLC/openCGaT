...
urlpatterns = [
    ...
    path('manage/<slug:partner_slug>/products/', views.manage_product_list, name='manage_product_list'),
    ...
    path('manage/<slug:partner_slug>/product/<slug:product_slug>/edit_related/', views.edit_related_products,
