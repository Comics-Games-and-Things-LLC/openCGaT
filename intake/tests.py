...
class GamesWorkshopTestCase(TestCase):
    ...
    def test_get_pack_quantity_from_name(self):
        ...
        self.assertEqual(get_pack_quantity_from_name("Base: Abaddon Black (12ml)"), 6)
        self.assertEqual(get_pack_quantity_from_name("Citadel Shade: Nuln Oil (18ml)"), 6)
        self.assertEqual(get_pack_quantity_from_name("Citadel Technical: Typhus Corrosion (24ml)"), 6)
        self.assertEqual(get_pack_quantity_from_name("Layer: Auric Armour Gold 12 ml"), 6)
        self.assertEqual(get_pack_quantity_from_name("Contrast Paint: Baal Red 18ML"), 6)
        self.assertEqual(get_pack_quantity_from_name("Technical Paint 24 ML"), 6)
        # Test specific Games Workshop formats
        self.assertEqual(get_pack_quantity_from_name("CONTRAST: LEVIATHAN PURPLE (18ML) (6PK)"), 6)
        self.assertEqual(get_pack_quantity_from_name("CONTRAST: LUXION PURPLE (18ML) (6 PACK)"), 6)
        self.assertEqual(get_pack_quantity_from_name("DRY: ASTORATH RED (6-PACK)"), 6)
        self.assertEqual(get_pack_quantity_from_name("DRY: HOETH BLUE (X6)"), 6)
        self.assertEqual(get_pack_quantity_from_name("L: KAKOPHONI PURPLE 12ML JUC X6"), 6)
        self.assertEqual(get_pack_quantity_from_name("L: SONS OF HORUS GREEN 12ML JUC X6"), 6)
        self.assertEqual(get_pack_quantity_from_name("L: PHALANX YELLOW 12ML JUC X6"), 6)
        self.assertEqual(get_pack_quantity_from_name("LAYER: CASTELLAX BRONZE (12ML) (6-PACK)"), 6)
        self.assertEqual(get_pack_quantity_from_name("Dice Set (x12)"), 12)
        self.assertEqual(get_pack_quantity_from_name("Item X3"), 3)
        self.assertIsNone(get_pack_quantity_from_name("Citadel Spray: Chaos Black (400ml)"))
